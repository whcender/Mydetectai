  ...
  return (
    <div>
      <div className='text-white mt-16 w-[90%] flex gap-6 flex-col justify-center items-center m-auto'>
        ...
        <p className='font-nato text-lg'>you can stay on the 8$ plan until you have enough active users to justify monoging their data or you start selting things</p>
      </div>
      <div>
        <Fiyat />
      </div>
