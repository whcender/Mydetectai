    ...
    return (
        <div className='text-white   mt-36 max-lg:mt-36'>
            <div className='w-[80%]  max-lg:w-[90%] m-auto max-lg:flex-col flex justify-between items-center max-md:gap-6'>
                <h1 className='text-[55px] max-lg:text-[40px] max-md:text-[30px] w-[35%] max-xl:w-[70%] max-lg:w-[90%] max-2xl:text-[35px]  font-darker'>Harnessing Artificial Intelligence Tools for <br /> Naturally Image Generator</h1>
